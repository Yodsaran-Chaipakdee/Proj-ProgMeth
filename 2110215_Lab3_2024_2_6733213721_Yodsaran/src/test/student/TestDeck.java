...
public class TestDeck {
	...
	void testRemoveCard() {
		try {
			assertEquals(8, deck2.getDeckSize());
			Card removeCard = deck2.removeCard(0);
			assertEquals(removeCard, cardList2[0]);
			assertEquals(7, deck2.getDeckSize());

			Card removeCard2 = deck2.removeCard(0);
			assertEquals(removeCard2, cardList2[1]);
			assertEquals(6, deck2.getDeckSize());

			Card removeCard3 = deck3.removeCard(2);
			assertEquals(removeCard3, cardList3[2]);
