...
public class LogicUtil {
	public static Ingredient createIngredientFromName(String s) throws InvalidIngredientException{
		switch(s) {
		case "Lettuce":
			return new Lettuce();
		case "Meat":
		...
		case "Bread":
			return new Bread();
		default:
			throw new InvalidIngredientException("There is no Ingredient named "+s);
		}
	}
	...
	public static String[] getRandomIngredientOrder() {
		...
		case 2:
			return new String[] {"Bread", "Chopped Lettuce", "Cooked Burger"};
		case 3:
			return new String[] {"Bread", "Chopped Lettuce", "Sunny Side Egg"};
		case 4:
		...
		case 7:
			return new String[] {"Bread", "Chopped Lettuce", "Cooked Burger", "Sunny Side Egg"};
		default:
			return null;
		}
	}
